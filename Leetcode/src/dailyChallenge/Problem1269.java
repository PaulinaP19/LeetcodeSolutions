...
public class Problem1269 {
	...
	/*
	 * public static void main(String[] args) { Problem1269 p = new Problem1269();
	 * int sol = p.numWays(3,2); System.out.println((sol == 4)+" "+sol); sol =
	 * p.numWays(2,4); System.out.println((sol == 2)+" "+sol); sol = p.numWays(4,2);
